...
// scroll page for get more tweets
...
// check if scroll Done now we can scrapp tweets
...
let recursiveCommentsCrawler = async function (
  ...
  if (tweetMap[getIdFromTwitterUrl(comment_url)]?.published?.split("T")[0] >= max_tweets_date) {
